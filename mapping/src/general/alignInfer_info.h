...
private:
	...
	// required by spliceDataBase format
	string flankString_hap1;
	string flankString_hap2;
	double branchRatio_doner;
	double branchRatio_acceptor;
public:
	AlignInfer_Info()
	{
		pathNum_backward = 0;
	...
	void initiateAlignInferInfo_chrNamePos_strand(int mapChrNameInt,
		int tmpSJposDonerEnd, int tmpSJposAcceptorStart, string& tmpSJstrand, Index_Info* indexInfo)
	{
		chrNameInt = mapChrNameInt;
		//cout << "chrNameInt: " << mapChrNameInt << endl;
		donerEndPos = tmpSJposDonerEnd;
	...
	void initiateAlignInferInfo_chrNamePos_supportNum_anchorSize_branchRatio_hapFlkStr(
		int mapChrNameInt, int tmpSJposDonerEnd, int tmpSJposAcceptorStart, int tmpSJsupportNum, 
		int tmpSJanchorSizeDonerEnd, int tmpSJanchorSizeAcceptorStart, Index_Info* indexInfo,
		double tmpJuncDonerBranchRatio, double tmpJuncAcceptorBranchRatio, 
		string& tmpJuncFlkStr_ref, string& tmpJuncFlkStr_hap1, string& tmpJuncFlkStr_hap2)
	{
		...
		anchorSizeMax_doner = tmpSJanchorSizeDonerEnd;
		anchorSizeMax_acceptor = tmpSJanchorSizeAcceptorStart;
		branchRatio_doner = tmpJuncDonerBranchRatio;
		branchRatio_acceptor = tmpJuncAcceptorBranchRatio;
		flankStringStr = tmpJuncFlkStr_ref;
		flankString_hap1 = tmpJuncFlkStr_hap1;
		flankString_hap2 = tmpJuncFlkStr_hap2;		
	}
