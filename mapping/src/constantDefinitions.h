...
// Parameters to call SNPs
#define LEARNSNP_DISTANCE2EXONBOUNDARY_MIN 10
#define LEARNSNP_MISMATCHNUM_MAX 2
#define LEARNSNP_CANDIMAPOPTIONNUM_MAX 1
#define LEARNSNP_COMPLETEPAIRONLY_BOOL true

#define FILTER_LEARNSNP_SUPNUMMIN 5
#define FILTER_LEARNSNP_RATIOMIN 0.9
