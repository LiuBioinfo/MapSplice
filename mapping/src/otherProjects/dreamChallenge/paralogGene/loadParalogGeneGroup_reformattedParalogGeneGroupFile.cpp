...
int main(int argc, char** argv)
{
	if(argc != 3)
	{
		cout << "Executable inputReformattedParalogGeneGroupFile outputFilePrefix" << endl;
		exit(1);
	}
	cout << "start to load reformattedParalogGeneGroupFile" << endl;
	string inputReformattedParalogGeneGroupFile = argv[1];
