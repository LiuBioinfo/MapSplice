	...
	Index_Info* indexInfo)
{
	...
	if(tmp1stMapIter == ((fusionJuncMapVecVec[detectedChrNameInt_1])[detectedChrNameInt_2]).end()) // breakPoint_1 not found
	{
