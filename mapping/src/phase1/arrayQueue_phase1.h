...
public:
		...
		const string& tmpReadSeq_2, ofstream& input_log_ofs)
	{
		...
		input_log_ofs << "... input 2 new array starts ......" << endl;  
	...
	void pushBack2currentFrontReadArray(const string& tmpReadName_1, const string& tmpReadName_2,
		const string& tmpReadSeq_1, const string& tmpReadSeq_2)
	{
		tailNode->pushBack2ReadArray(tmpReadName_1, tmpReadName_2, tmpReadSeq_1, tmpReadSeq_2);
	}

	void pushBack2currentFrontReadArray_fq(const string& tmpReadName_1, const string& tmpReadName_2,
		const string& tmpReadSeq_1, const string& tmpReadSeq_2, const string& tmpReadQualSeq_1,
		const string& tmpReadQualSeq_2)
	{
		tailNode->pushBack2ReadArray_fq(tmpReadName_1, tmpReadName_2, tmpReadSeq_1, tmpReadSeq_2,
			tmpReadQualSeq_1, tmpReadQualSeq_2);
	}
